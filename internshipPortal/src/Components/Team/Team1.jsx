...
const Team1 = ({ name, post, title, description, img_url }) => {
  return (
   <>
        ...
        <div className="p-4 md:w-1/2 lg:w-1/2 sm:mb-0 mb-6 my-10 ">
          ...
          <h2 className="name text-[0.8rem] md:text-xl font-medium title-font text-amber-700 mt-2 uppercase">{name}</h2>
          <div className="w-[60%] h-[0.7px] bg-blue-800 my-1 uppercase"></div>
          <h2 className="text-[1rem] font-normal text-gray-800">{title}</h2>
          <p className="text-base mt-2 text-justify md:text-center">{description}</p>
